  ...
  return (
    <>
      <div className="flex items-center justify-between mx-5 ">
        <div>
          <Link to={'/employee  '}><img onClick={()=>setOpen(false)} src={Logo} className="cursor-pointer w-[70px] sm:w-[80px] lg:w-[100px]" alt="Logo" /></Link>
        </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <Link
                ...
                onClick={() => setOpen(false)} 
              >
                <i className="fa-solid fa-bookmark text-[20px]"></i>Job Application
              </Link>
